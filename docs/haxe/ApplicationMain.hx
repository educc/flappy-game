...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FlappyGame", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FlappyGame", null, 360, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "38";
		app.meta["company"] = "Edward Cacho";
		app.meta["file"] = "FlappyGame";
		app.meta["name"] = "FlappyGame";
		app.meta["packageName"] = "com.ecacho.flyfaraway";
